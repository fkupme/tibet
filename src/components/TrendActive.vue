		...
		<article class="trend-active" :style="background">
			<div href="#" class="trend-active-link trend-active-blur" @click.prevent >
					...
					<div class="trend-active-description">
						<p class="trend-active-description__text" :class="{'trend-active-description__text_show' : show}">{{ card.description }}</p>
					</div>
					<ul class="trend-active-activities-list">
						<li class='trend-active-activities-list__item' v-for="activity in card.activities" :key="activity">{{ activity }}</li>
					</ul>
					<button class="trend-active-name-price__button">{{ card.price }}$</button>
				</div>
			</article>
	</div>
</template>
